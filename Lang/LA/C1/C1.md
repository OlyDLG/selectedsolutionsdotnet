...
<table>
  <tr>
   <th colspan=5>Section 1: Definitions</th>
  </tr>
  <tr>
    <td><a href="#E1.0">Exercise 1.0</a></td>
    <td><a href="#E1.1">Exercise 1.1</a></td>
    <td><a href="#E1.2">Exercise 1.2</a></td>
    <td><a href="#E1.4">Exercise 1.4</a></td>
    <td><a href="#E1.7">Exercise 1.7</a></td>
  </tr>
  <tr>
    <td><a href="#E1.9b">Exercise 1.9b</a></td>
    <td><a href="#E1.10">Exercise 1.10</a></td>
    <td><a href="#E1.11">Exercise 1.11</a></td>
    <td colspan=2><a href="#E1.14">Exercise 1.14</a></td>
  </tr>
  <tr>
   <th colspan=5>Section 2: Bases</th>
  </tr>
  <tr>
    <td><a href="#E2.9">Exercise 2.9</a></td>
    <td><a href="#E2.10">Exercise 2.10</a></td>
  </tr>
  <tr>
   <th colspan=5>Section 4: Sums and Direct Sums</th>
  </tr>
  <tr>
...
$O \underset{\text{Pf in text}}{=} 0v \underset{\text{PoF}}{=} (1+(-1))v \underset{\mathbf{VS6~\&~8}}{=} v + (-1)v$; now add $-v$ to both sides to get $-v + O = -v + v + (-1)v$; by <b>VS2</b> the left-hand-side (LHS) equals $-v$ and by <b>VS1</b> the RHS equals $O + (-1)v \underset{\mathbf{VS2}}{=} (-1)v.~~~\blksq$
<br><br>
...
<b>Pf</b>: Let $v \in V\text{; by } \mathbf{VS3},~\exists (-v) \in V : -v + v = O_{_V}$, (&quot;:&quot;  means &quot;such that&quot;) $\therefore cO_{_V} \underset{\text{substitution}}{=} c(-v + v) \underset{\mathbf{VS5}}{=} c(-v) + cv \underset{\text{Exercise 0}}{=} c(-1(v)) + cv \underset{\mathbf{VS7}~\text{& PoF}}{=} (-c)v +cv \underset{\mathbf{VS6}}{=} (-c + c)v \underset{\text{PoF}}{=} 0v \underset{\text{Pf in text}}{=} O_{_V}.~~~\blksq$
<br><br>

<a name="E1.2" class="goback" onclick="winhisback()">__1.2__)</a>
Given $c \in K, c \ne 0, v \in V_{_K}$; show that $(cv = O) \implies v = O$.

<b>Pf</b>: Since $c \ne 0, \Frac1c  \underset{\text{PoF}}{\in} K \therefore O \underset{\text{Exercise 1}}{=} \Frac1c O \underset{\text{by assumption}}{=} \Frac1c(cv) \underset{\mathbf{VS7}}{=} \left(\Frac{c}c\right)v \underset{\text{PoF}}{=} (1)v \underset{\mathbf{VS8}}{=} v.~~~\blksq$
<br><br>
...
<b>Pf</b>: $v + w \underset{\text{by assumption}}{=} O \underset{\mathbf{VS3}}{=} v + (-v)$; now add $-v$ to both sides: $\left[-v + (v + w) = -v + (v + (-v))\right]  \underset{\mathbf{VS1}}{\implies} \left[(-v + v) + w = (-v + v) + (-v)\right] \underset{\mathbf{VS3~\&~4}}{\implies} \left[O + w = O + (-v)\right] \underset{\mathbf{VS2}}{\implies} w = -v.~~~\blksq$
<br><br>
...
<b>Pf</b>: $O_{\mathbb{R}^3} = (0,0,0) \in X \because 0 = 0$ and $2(0) = 0$; $(x,y,z) \in X$ and $c \in \mathbb{R}\implies c(x,y,z) \in X \because x=y \implies cx = cy$ and $2y = z \implies 2cy = cz$; and $(x,y,z), (\xi, \psi, \zeta) \in X \implies (x+\xi, y+\psi, z+\zeta) \in X \because x=y, \xi=\psi \implies x + \xi = y + \psi$ and $2y = z, 2\psi = \zeta \implies 2(y+\psi) = z+\zeta.~~~\blksq$ 
<br><br>
...
For $U+W$, first note that, $\because U, W \overset{\rightharpoonup}{\subset} V, O_U + O_W = O_V + O_V = O_V \therefore O_V \in U+W$. Next, suppose $\u, \omega \in U+W$; this $\implies \exists u_1, u_2 \in U, w_1, w_2 \in W : \u = u_1 + w_1, \omega = u_2 + w_2$; now consider $\u + \omega = u_1 + w_1 + u_2 + w_2 = (u_1 + u_2) + (w_1 + w_2); \because U, W$ are vector spaces, $u_1 + u_2 \in U, w_1 + w_2 \in W, \therefore (\u + \omega) \in U+W$; finally, $\u \in U+W \implies \exists u \in U, w \in W : \u = u+w \therefore c\u~(c \in K) = cu + cw$ and again, since $U, W$ are vector spaces, $cu \in U, cw \in W \therefore c\u \in U+W.~~~\blksq$
<br><br>
...
VS1 through VS8 all follow similarly, i.e., the above choices for vector addition and multiplication of a vector by a scalar make VS1-8 follow immediately from $L$ being a field. $~~\blksq$ 
<br><br>
...
Case none of $a,b,c,d=0$: in this case $ad-bc=0$ implies, for example, $d=\Frac{bc}a, b=\Frac{ad}c$, and thus if we choose $x=c, y=-a$, then $xU+yV = c(a,\Frac{ad}c)-a(c,\Frac{bc}a) = (ac-ac,ad-bc) = (0,0).~~~\blksq \text{A}$
...
We must show that given an element $(v_1,v_2,v_3)$ of $V$, there exists a unique element $\omega = w(1,0,0)$ of $W$ and a unique element $\u = u_1(1,1,0)+u_2(0,1,1)$ of $U :$ $(v_1,v_2,v_3) = \omega + \u = w(1,0,0) + u_1(1,1,0)+u_2(0,1,1)$. This gives the simultaneous linear system: 
$$\begin{eqnarray}
w&+&u_1&   &      &=&v_1&~~(1) \\
   &   &u_1&+&u_2&=&v_2&~~(2)\\
   &   &      &   &u_2&=&v_3&~~(3)
...
Eq. 3 immediately gives $u_2 = v_3$; substituting this into Eq. 2 gives $u_1 = v_2 - v_3$, and substituting this into Eq. 1 yields $w = v_1-v_2+v_3$. Since $v_1,v_2,v_3$ are elements of a field, these $w, u_1, u_2$ are well- and uniquely defined.$~~~\blksq$
<br><br>
...
__Direct Sum__: $A,B$ a basis of $\mathbb{R}^2 \implies A’+B’=\mathbb{R}^2$ (why, exactly?) so by Theorem 4.1, we just need to show that $A’ \cap B’ = \{O\}$. Suppose not, i.e., suppose $\exists x \in \mathbb{R}^2 : \exists a,b \in \mathbb{R} : x=aA=bB$; then $aA-bB = O$, but by the linear independence of $A,B, a=b=0$, i.e., $x=O.$<br>$\blksq$
<br>
