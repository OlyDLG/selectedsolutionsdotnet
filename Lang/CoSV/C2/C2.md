...
<title>Solutions of Selected Exercises from Lang, S "Calculus of Several Variables 3rd Ed. Chapter 2"</title>
...
<table>
  <tr style="border: none;">
    <td style="border: none;"><a href="#E1.8">Exercise 1.8a</a></td>
    <td style="border: none;"><a href="#E1.9">Exercise 1.9a-c</a></td>
    <td style="border: none;"><a href="#E1.11">Exercise 1.11a-c</a></td>
    <td style="border: none;"><a href="#E1.13">Exercise 1.13 & 14</a></td>
    <td style="border: none;"><a href="#E1.15">Exercise 1.15</a></td>
  </tr>
  <tr style="border: none; background-color: white;">
    <td style="border: none;"><a href="#E1.19">Exercise 1.19</a></td>
    <td style="border: none;"><a href="#E1.20">Exercise 1.20a & b</a></td>
    <td style="border: none;"><a href="#E1.23">Exercise 1.23b</a></td>
    <td style="border: none;"><a href="#E1.25">Exercise 1.25a & b</a></td>
    <td style="border: none;"><a href="#E1.26">Exercise 1.26b</a></td>
  </tr>
  <tr style="border: none;">
    <td style="border: none;"><a href="#E2.3">Exercise 2.3b</a></td>
...
<a name="E1.8" class="goback" onclick="winhisback()">__1.8a__)</a>
Find the plane normal to the curve $\gamma(t) = (e^t, t, t^2)$ for $t=1$.
...
Given: $P = (1,2,3,4),~ Q=(4,3,2,1),~ A=(1,1,1,1),~ L(t) \parallel A$, passes through $P$.
...
$X(t) \subset \mathbb{R}^n$ is a differentiable curve over $t \in (a,b), a \lt b \in \mathbb{R}, Q \in \mathbb{R}^n \notin X(t)$.
...
<a name="E1.13" class="goback" onclick="winhisback()">__1.13 & 14__)</a>
Prove that speed, $|\mathbf{v}|$, constant $\iff$ acceleration, $\dot{\mathbf{v}}$, perpendicular to velocity, $\mathbf{v}$.
...
<a name="E1.19" class="goback" onclick="winhisback()">__1.19__)</a>
Find the intersection of the curve $\mathbf{X}(t) = (2t^2, 1-t, 3+t^2)$ and the plane $3x - 14y + z - 10 = 0$.
...
<a name="E1.20" class="goback" onclick="winhisback()">__1.20__)</a>
Let $\mathbf{X}(t)$ be a (sufficiently) differentiable curve on some interval $I$ and suppose:
...
<a name="E1.23" class="goback" onclick="winhisback()">__1.23b__)</a>
Given: $\mathbf{B}$ a fixed <i>unit</i> vector, and $\mathbf{X}(t) :\mathbf{B} \cdot \mathbf{X} = e^{2t}~\forall t$ (note: the additional "given" information in the Exercise statement is not needed for part b). Calculate $\mathbf{X}’(t) \cdot \mathbf{X}’’(t)$.
...
<a name="E1.25" class="goback" onclick="winhisback()">__1.25__)</a>
Suppose differentiable $\mathbf{B} (t) = (x(t), y(t), z(t))$ satisfies $z^2 = 1 + x^2 + y^2$ for all $t$.
...
<a name="E1.26" class="goback" onclick="winhisback()">__1.26b__)</a>
Calculate the equation of the plane normal to $\mathbf{X}(t) = (t, t^2, \frac23t^3)$ at $t=1$
...
<a name="E2.3" class="goback" onclick="winhisback()">__2.3b__)</a>
Calculate the length of $\mathbf{X}(t) = (e^{3t}, e^{-3t}, 3\sqrt2t) \text{ between } t=0 \text{ and } \frac13$.
...
Calculate the length of $\mathbf{X}(t) = (t, \log\cos t) \text{ between } t=0 \text{ and } \frac{\pi}4$.
...
Calculate the length of $\mathbf{X}(t) = (6t, 2t^3, 3\sqrt2 t^2) \text{ between } t=0 \text{ and } 1$.
