...
#### <center>Selected Exercise Solutions: Chapter 1
#### <center>&copy; 2019 by
...
a) <img src="http://www.selectedsolutions.net/Lang/CalcOfSevVar/C1/1.9a.png" alt="./1.9a.png" align="top" height="240" width="240">&nbsp;
b) <img src="http://www.selectedsolutions.net/Lang/CalcOfSevVar/C1/1.9b.png" alt="./1.9b.png" align="top" height="240" width="240">&nbsp;
c) <img src="http://www.selectedsolutions.net/Lang/CalcOfSevVar/C1/1.9c.png" alt="./1.9c.png" align="top" height="240" width="240">&nbsp;
d) <img src="http://www.selectedsolutions.net/Lang/CalcOfSevVar/C1/1.9d.png" alt="./1.9d.png" align="top" height="240" width="240">&nbsp;
<br>
...
<b>Sln.:</b> $Q - P = (-3, 0, 9), B - A = (-9, 0, -27)~\therefore,~\because \nexists a \in \mathbb{R}$ s.t. $Q - P = a(B - A),$ <b>not parallel</b>.
<br><br>
...
<b>1.3.5)</b> Given that $A \cdot X = 0~\forall X$, show $A = \vec0$.
...
<b>Sln.:</b> Think geometrically: two vectors, perpendicular to a third, will both have a dot product of zero with the third, and yet they clearly need not be equal to one another; indeed, they can even be pointed in opposite directions!&nbsp;  Thus, say, let $A = (1, 1), B = (-1, 1), C = (1, -1);$ clearly $B \ne C$, but $A \cdot B = -1 + 1 = 0 = 1 + (-1) = A \cdot C.~\blacksquare~$ (More generally, in two dimensions, because $\cos(\theta/2) = \cos(-\theta/2)$, any bisector, $A$, of the angle formed by any two other, unequal-but-equal-in-magnitude vectors, $B \ne C~s.t. ||B||=||C||$, will "serve" as the required counterexample; given a vector, how many vectors "serve" in three dimensions?) 
<br><br>
...
$||\alpha(Q - P)|| = \alpha||Q - P||$ (since $\alpha$ is non-negative by hypothesis).&nbsp; Now, with this formula at our disposal, a-d) become trivial, but I'll do d) anyway to illustrate the use of the formula: the point $\frac25$-ths of the way from $P$ to $Q$ is:<br>
$(1-\frac25)P + \frac25Q = \frac35(1, 3, -1) + \frac25(-4, 5, 2) = (-1, \frac{19}5, \frac15).$  (Exercise for the Reader: verify this result using the 3-D distance formula.)&nbsp;&nbsp;&nbsp;$\blacksquare$
<br><br>
...
<b>1.6.14)</b> Find the $\cap$ of the line through $P$ in the direction of $A$ and the given plane<br>
<b>a)</b> $P = (1, 3, 5),~A = (-2, 1, 1),~2x + 3y - z = 1$

<b>Sln.:</b> A parameterization for the line $L(t)$ through $P$ in the direction of $A$ is $L(t) = P + tA \because L(0) = P$ and $tA$ has the same direction as $A~\forall t \in \mathbb{R}\ne 0$; in terms of components $L(t) = (1,3,5) + t(-2, 1, 1).~$ Substituting into the equation of the plane gives $1 = 2(1-2t) + 3(3+t) - (5+t) = 6 - 2t \implies t = \frac52 \implies \boxed{\cap = (-4, \frac{11}2, \frac{15}2)}$.<br>
Check: $2(-4) +3(\frac{11}2) - \frac{15}2 = -8 + \frac{18}2 = 1~\checkmark$<br>

<b>b)</b> $P = (1, 2, -1),~A = (3, -4, 1),~3x - 4y + z = 2$

<b>Sln.:</b> $L(t) = (1, 2, -1) + t(3, -4, 1) = (1+3t, 2-4t, -1+t)$; substituting into $3x - 4y + z = 2 \implies 2 = 3(1+3t) - 4(2-4t) + (-1+t) = -6 + 26t \implies t = \frac4{13} \implies \boxed{\cap = (\frac{25}{13}, \frac{10}{13}, -\frac9{13})}$
<br><br>
...
<b>Sln.:</b> Let $X(t) = (x_1(t), x_2(t), x_3(t))$ and similarly for $Y(t)$; for clarity of notation, we will henceforth drop the $(t)$’s.&nbsp; We have: 
