...
Confession: I find $\d$&#8209;$\e$ proofs hard to follow, which probably explains why I had a hard time writing this part of the proof in such a way that I found &quot;convincing&quot;; what finally worked for me was composing the proof using the organizing tool of a &quot;proof table,&quot; the kind taught in high school geometry. I’m tempted to present the proof in that format, but that’s frowned upon after high school geometry, so I’m going to &quot;compromise&quot; and present it as a &quot;narrative,&quot; with explicit justification for each step in parentheses.<br>

$\forall \e \gt 0~\exists N \in \mathbb{N} : n \in \mathbb{N} \ge N \rarrow \left|z_n - w\right| \lt \e \implies \forall \e \gt 0~\exists N : n \ge N \rarrow \left|f(1/n) - w\right| \lt \e~(z_n = f(1/n) \text{ given}) \implies$ $\forall \e \gt 0~n \gt N \rarrow \left|f(1/n) - w\right| \lt \e~(\text{true for } n \ge N \rarrow \text{ true for } n \gt N) \implies \forall \e \gt 0,~0 \lt \Frac1n \lt \Frac1N \rarrow \left|f(1/n) - w\right| \lt \e$ $(n \gt N \gt 0 \rarrow 0 \lt \Frac1n \lt \Frac1N).$ Now choose $\d = \Frac1N \gt 0~(\text{axiom of choice; } \Frac1N \gt 0)$ and let $z = \Frac1n \implies z \in S, \left|z\right| \lt \d~($definition of $S$, $\Frac1n \lt \Frac1N) \implies \forall \e \gt 0~\exists \d \gt 0 : z \in S, \left|z\right| \lt \d \rarrow \left|f(z) - w\right| \lt \e,$ which is what we were required to show.  
