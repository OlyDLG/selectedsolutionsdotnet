...
<body onload="JSnote(); G5P1();">
#### <center>Gitman, L. J., 2003. <i>Principles of Managerial Finance (Brief) 3rd Edition.</i> 
#### <center>Addison-Wesley, Boston.
#### <center>Selected Chapter-End Problem Solutions
## <center>Chapter 5: Risk and Return
#### <center>&copy; 2019 by
#### <center>David Lawrence Goldsmith
#### <center>for
#### <center>www.selectedsolutions.net</center>
...
<sp id="JSnote"></sp> signifies a result generated and/or placed by JavaScript.
