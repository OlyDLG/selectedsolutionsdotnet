...
<i>Notes:  These solutions are provided &quot;as-is,&quot; for informational purposes only, with no warranty of any kind, expressed or implied, including that of correctness, adequacy, and/or suitability for any purpose, whatsoever.</i> 
...
Calculators for the ratios discussed in this chapter, implemented as HTML5 Forms and utilizing JavaScript functions implementing those ratios (enter values in the boxes to see calculated values on the right):
