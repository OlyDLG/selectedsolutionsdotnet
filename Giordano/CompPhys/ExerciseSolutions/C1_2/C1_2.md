...
<center>
  <table>
    <tr style="border: none;">
      <td style="border: none;">
        <form id="C2E14Xwind" onchange="makeC2E14Graph()">
          <label for="C2E14XwindIn">Crosswind speed:</label>
          <input type="number" name="C2E14XwindIn" min="0" max="25" step="5" value="10"> (miles/hour)
        </form>
      </td>
      <td style="border: none;">
        <form id="C2E14LaunchAngle" onchange="makeC2E14Graph()">
          <label for="C2E14LaunchAngleIn">Launch angle:</label>
          <input type="number" name="C2E14LaunchAngleIn" min="35" max="55" step="2.5" value="45"> (degrees)
        </form>
      </td>
      <td style="border: none;">
        <form id="C2E14ExitV" onchange="makeC2E14Graph()">
          <label for="C2E14ExitVIn">Exit velocity:</label>
          <input type="number" name="C2E14ExitVIn" min="90" max="110" step="5" value="100"> (degrees)
        </form>
      </td>
    </tr>
  </table>
