...
### Contents
[Exercise 1.4](#E1.4)<br>
[Exercise 1.5](#E1.5)<br>
[Exercise 2.5](#E2.5)<br>
[Exercise 2.14](#E2.14)<br>
[Exercise 2.21](#E2.21)<br>
[Source code links](#Source)<br>
[Notes, Credits, Donate links](#Notes)

### <a class="tooltip-container" name="E1.4" onclick="window.history.back()">_Exercise 1.4_<span class="tooltip-text">Click link to return to prior place</span></a>
...
### <a class="tooltip-container" name="E1.5" onclick="window.history.back()">_Exercise 1.5_<span class="tooltip-text">Click link to return to prior place</span></a>
...
### <a class="tooltip-container" name="E2.5" onclick="window.history.back()">_Exercise 2.5_<span class="tooltip-text">Click link to return to prior place</span></a> 
...
### <a class="tooltip-container" name="E2.14" onclick="window.history.back()">_Exercise 2.14_<span class="tooltip-text">Click link to return to prior place</span></a>
...
where, as in the text, $\displaystyle\frac{S_0}{m} = 4.1\times 10^{-4}, \frac{B_2}{m}$ is as in Exercise 2.14, and $\vec{\omega} = (0,0,\omega), \omega$ user-selectable. Discretized, this becomes:

$$\begin{eqnarray}
x_{n+1} & = & x_n + u_n\Delta t \\
y_{n+1} & = & y_n + v_n\Delta t \\
z_{n+1} & = & z_n + w_n\Delta t \\
u_{n+1} & = & u_n -\left(\frac{{B_2}_{n}}{m}\upsilon_n u_n + \frac{S_0}{m}(\vec{\omega} \times \vec{\upsilon}_n)_x\right)\Delta t \\
v_{n+1} & = & v_n - \left(\frac{{B_2}_{n}}{m}\upsilon_n v_n + \frac{S_0}{m}(\vec{\omega} \times \vec{\upsilon}_n)_y\right)\Delta t \\
w_{n+1} & = & w_n - \left(\frac{{B_2}_{n}}{m}\upsilon_n w_n + g\right)\Delta t \\
\end{eqnarray}
$$
...
### <a class="tooltip-container" name="Source" onclick="window.history.back()">Source Code (JavaScript)<span class="tooltip-text">Click link to return to prior place</span></a>
Local:
...
### <a class="tooltip-container" name="Notes" onclick="window.history.back()">Notes<span class="tooltip-text">Click link to return to prior place</span></a>
<a name="Note1" onclick="window.history.back()">1.</a> In order to highlight the effect of spin, we do not include wind in this Exercise; additionally, for the same purpose, we enable the reader to "turn off" (linear) drag in the lateral direction, despite that being "unphysical" (because without air resistance, spin does not give rise to a Magnus force).
