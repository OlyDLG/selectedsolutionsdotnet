    ...
    <tr style="border: none; background-color: white;">
      ...
      <td class="cen" style="border: none;">
        <div class="chart" id="GiorCPC3E20bddetLChart" 
             alt="Giordano/Nakanishi Comp. Phys. Chpt. 3 Ex. 20.   Bifurcation Diagram Detail Lower Portion"></div>
      </td>
      <td class="cen" style="border: none;">
        <div class="chart" id="GiorCPC3E20bddetUChart" 
            alt="Giordano/Nakanishi Comp. Phys. Chpt. 3 Ex. 20. Bifurcation Diagram Detail Upper Portion"></div>
      </td>
    </tr>
    <!--tr style="border: none; background-color: white;">
      <td colspan=3 class="cen" style="border: none;">
        $F_D$
      </td>
    </tr-->
  </table>
