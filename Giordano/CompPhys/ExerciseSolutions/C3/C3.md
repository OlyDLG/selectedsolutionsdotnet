...
<div id="GiorCPC3E24Title" style="center"></div>
<center>
  <table>
    <tr style="border: none;">
  ...
  <table>
    <tr style="border: none; background-color: white;">
      <th class="cen" style="border: none;">Model a)</th>
      <th class="cen" style="border: none;">Model b)</th>
    </tr>
    <tr style="border: none; background-color: white;">
      <th colspan=2 class="cen" style="border: none;">
...
$~~$Model a:<br>
$~~~~$Appears to be "good" for generating pseudorandom numbers:<br>

$~~~~$Appears to have a "long" cycle:<br>
...
$~~~~$Appear to have a "long" cycle:
$\alpha=3, \beta=0, x_0=0.3, Base=2, n=8$: appears to have a period-16 cycle.
$\alpha=3, \beta=0, x_0=0.4, Base=2, n=8$: appears to have a period-32 cycle.
$\alpha=3, \beta=0, x_0=0.8, Base=2, n=8$: appears to have a period-16 cycle.
$\alpha=3, \beta=0, x_0=0.9, Base=2, n=8$: appears to have a period-32 cycle.
$\alpha=5, \beta=0, x_0=0.3, Base=2, n=8$: appears to have a period-18 cycle.
