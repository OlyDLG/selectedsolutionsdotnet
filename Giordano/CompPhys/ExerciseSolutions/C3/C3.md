...
<i>Note 3: Links to the JavaScript source code files used in this document are provided </i>[here](#Source)
...
<a name="Parker" onclick="window.history.back()">Parker</a>, T. S. and L. O. Chua, 1989, <i>Practical Numerical Algorithms for Chaotic Systems</i>, Springer-Verlag, New York.
