...
### <a class="goback" name="E3.20" onclick="winhisback()">_Exercises 3.20_</a>
...
<div id="GiorCPC3E20Title" style="center"></div>

<form id="C3E20swtch" onchange="makeC3E20Graph()">
    <label for="C3E20swtchIn">Generate Plots (Note: takes a little while)</label>
    <input type="checkbox" name="C3E20swtchIn">
</form>

<center><table id="E20bifdiaGraphTable">
  <tr style="border: none;">
    <td class="cen" style="border: none;">
      PPM Bifurcation Diagram
    </td>
    <td class="cen" style="border: none;">
      Bifurcation Diagram Detail
    </td>
  </tr>
  <tr style="border: none; background-color: white;">
    <td class="cen" style="border: none;">
      <div class="chart" id="GiorCPC3E20bifdiaChart" alt="Giordano/Nakanishi Comp. Phys. Chpt. 3 Ex. 20. PPM Bifurcation Diagram"></div>
    </td>
    <td class="cen" style="border: none;">
      <div class="chart" id="GiorCPC3E20bddetChart" alt="Giordano/Nakanishi Comp. Phys. Chpt. 3 Ex. 20. Bifurcation Diagram Detail"></div>
    </td>
  </tr>
  <!--tr style="border: none; background-color: white;">
    <td class=cen style="border: none; transform: translate(0px, -50px);">$F_D$</td>
    <td class=cen style="border: none; transform: translate(0px, -50px);">$F_D$</td>
  </tr-->
</table></center>
...
Local:
[Exercise 4](./C3E4.js)$~~~~$[Exercise 8](./C3E8.js)$~~~~$[Exercise 16/7](./C3E16.js)<br>
