...
<table>
  ...
  <tr>
    ...
    <td><a href="#P2.2.8">2.2.8</a></td>
    <td><a href="#P2.2.12">2.2.12</a></td>
...
Problems 2.2.8 and 2.2.12: Solve the given IVP and state the interval in which the solution is valid.<br>

<a name="P2.2.8" class="goback" onclick="winhisback()">__2.2.8__)</a>


__Sln__:
<br><br>

<a name="P2.2.12" class="goback" onclick="winhisback()">__2.2.12__)</a>
