...
__Sln__: $\Frac{dN}{dt}(N) = k(1-N)^2, k \gt 0$, is an &quot;up&#8209;opening&quot; parabola with vertex at (1,0), and thus for $N \ne 1, \Frac{dN}{dt} \gt 0$; this implies that if $N_0 \lt 1$, $N(t)$ increases towards $N=1$ with increasing $t$, and if $N_0 \gt 1$, $N(t)$ increases away from $N=1$with increasing $t$; thus the equilibrium solution $\phi(t) = 1$ is semistable.
<br>
...
__Sln__: First, the specification $N_0 \ge 0$ is only necessary to ensure that the initial value of $dN/dt$ is real; otherwise, the value of $N_0$ does not affect the graph of $dN/dt$ vs. $N$, nor the equilibria or their (in)stability&mdash;it only affects the actual solution $N(t)$, which we have not been asked to find.<br> 

Now, the critical points are found by solving $0 = dN/dt = aN - b\sqrt N = (a\sqrt N - b)\sqrt N \implies \sqrt N = 0 \implies \box{N = 0}$ or $a\sqrt N - b = 0 \implies \box{N = \Frac{b^2}{a^2}}$.&nbsp; Examination of the graph of $dN/dt$ vs. $N$ (given below) clearly shows that for $0 \lt N \lt \Frac{b^2}{a^2}$, $dN/dt \lt 0 \implies N(t)$ is decreasing with increasing $t$ and $\box{0\text{ is stable}}$; while for $N \gt \Frac{b^2}{a^2}$, $dN/dt \gt 0 \implies N(t)$ is increasing with increasing $t$ and $\box{\frac{b^2}{a^2}\text{ is unstable}}$.<br>

Here’s the graph of $dN/dt$ vs. $N$ indicating the equilibria and the intervals over which $N(t)$ is decreasing and increasing with increasing $t.$<br>
...
__Sln__: $0 = dN/dt = rN\log(K/N) \implies \log(K/N) = 0 \implies K/N = 1 \implies \box{N=K}$ is one critical point; additionally, even though $\log(K/0)$ is undefined, $\lim_{N\rarrow0^{+}}rN\log(K/N) = \lim_{N\rarrow0^{+}}\Frac{r\log(K/N)}{1/N}$ &quot;$=$&quot; $\Frac{\infty}{\infty}$, so, applying L’Hopital’s Rule, $ = \lim_{N\rarrow0^{+}}\Frac{r(N/K)(-K/N^2)}{-1/N^2} = \lim_{N\rarrow0^{+}}rN = 0$ so $dN/dt$ has a removable discontinuity at $N=0$ and the value of the derivative there is $0$, so $\box{N=0}$ is also a critical point.&nbsp; The graph of $dN/dt$ vs. $N$:

<div class="tqimg"><img src="./Graphs/BoyceDiPrimaC2S6P16.png"></div>

indicates that $dN/dt \gt 0$ for $0 \lt N \lt K \implies N(t)$ is increasing with increasing $t$ on this interval and thus $\box{0\text{ is unstable}}$, whereas $dN/dt \lt 0$ for $N \gt K \implies N(t)$ is decreasing with increasing $t$ on that interval and thus $\box{K\text{ is stable}}$.
<br>
