...
Setting $a = \Frac km$, an integrating factor for Eq. 1 is $\mu(t) = \exp\left(\Int a dt\right) = e^{at}$ and multiplying Eq. 1 through by $\mu(t)$ yields:

$$e^{at}\frac{d\u}{dt} + ae^{at}\u = \frac d{dt}\left(e^{at}\u\right) = ge^{at} \implies e^{at}\u = \frac ga e^{at} + C_{\u} \implies \box{\u = \frac ga + C_{\u}e^{-at}}$$

Setting $\u(0) = \u_0$, we have $\u_0 = \Frac ga + C_{\u}e^{-a(0)} \implies \box{C_{\u} = \u_0 - \Frac ga}.~$ Check: IC: $\u(0) = \Frac ga + \left(\u_0 - \Frac ga\right)e^{-a(0)} = \u_0~\chec$; DE: $\Frac{d\u}{dt} + a\u = -aC_{\u}e^{-at} + a\left(\Frac ga + C_{\u}e^{-at}\right) = g.~\chec$

To obtain $x(t)$, we simply set $\Frac{dx}{dt} = \u(t) = \Frac ga + C_{\u}e^{-at} \implies x = \Int\left(\Frac ga + C_{\u}e^{-at}\right)dt = \box{\Frac ga t - \Frac{C_{\u}}a e^{-at} + C_x}$; setting $x(0) = x_0 = \Frac ga (0) - \Frac{C_{\u}}a e^{-a(0)} + C_x = -\Frac{C_{\u}}a + C_x \implies \box{C_x = x_0 + \frac{C_{\u}}a}.~$ Check: IC: $x(0) = \Frac ga (0) - \Frac{C_{\u}}a e^{-a(0)} + x_0 + \Frac{C_{\u}}a = x_0~\chec$; DE: $\Frac{dx}{dt} = \Frac ga -(-a)\Frac{C_{\u}}a e^{-at} = \Frac ga + C_{\u}e^{-at} = \u(t).~\chec$
