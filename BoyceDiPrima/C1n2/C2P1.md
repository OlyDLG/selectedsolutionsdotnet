...
__Sln__: Begin by noting that $y$ can’t equal $\pm2/\sqrt3$; excluding those values of $y$, the DE is equivalent to $3x^2dx - (3y^2 - 4)dy = 0 \implies x^3 - y^3 + 4y = C$; the IC gives $1^3 - 0^3 + 4(0) = 1 = C$, which implies the formal solution, expressed implicitly (we are not asked to express the solution explicitly), is $x^3 - y^3 + 4y = 1$.&nbsp; Now, ___if___ the solution were well&#8209;defined at $y = \pm2/\sqrt3$, the corresponding values of $x$ would be determined from $x^3 = (\pm2/\sqrt3)^3 - 4(\pm2/\sqrt3) + 1 = \pm8/(3\sqrt3) \mp 24/(3\sqrt3) + 1 = 1 \mp16/(3\sqrt3)$ so the points excluded from the solution are $\box{\left(\sqrt[3]{1 - 16/(3\sqrt3)}, 2/\sqrt3\right)}$ and $\box{\left(\sqrt[3]{1 + 16/(3\sqrt3)}, -2/\sqrt3\right)}$.<br><br>
