...
### <center>Chapter 2, Part 1: First Order Differential Equations, Sections 1 through 6
### <center>&copy; 2026 by
...
__Pf__: For $n \ne 0, 1$, $\u = y^{1-n} \implies \u’ = (1-n)y^{-n}y’$; since our objective is to show that the substitution puts the equation into the form $\u’ + P(x)\u = Q(x)$ for some $P$ and $Q$, we try multiplying the given equation through by $(1-n)y^{-n}$: $(1-n)y^{-n}q(x)y^n = (1-n)q(x) = Q(x) = (1-n)y^{-n}y’ + (1-n)p(x)y^{-n}y = (y^{1-n})’ + (1-n)p(x)y^{1-n} = \u’ + P(x)\u$ with $P(x) = (1-n)p(x)$ and $\u = y^{1-n}.~~\blacksquare$
<br><br>
