...
<title>Solutions of Selected Problems from Boyce/DiPrima "Elem. DEs & BVPs 5th Ed. Chapter 1"</title>
$\require{cancel}
...
<table>
  <tr>
    <th >Problem #: </th>
    <td><a href="#P1.1.6">6</a></td>
    <td><a href="#P1.1.14">14</a></td>
    <td><a href="#P1.1.18">18</a></td>
    <td><a href="#P1.1.20">20</a></td>
    <td><a href="#P1.1.26">26</a></td>
    <td><a href="#P1.1.32">32</a></td>
    <td><a href="#P1.1.40">40</a></td>
  </tr>
</table>
</div>
...
Check: $y = x^1 \implies y’ = 1, y’’ = 0 \implies x^2y’’ - 4xy’ + 4y = x^2(0) - 4x(1) + 4x = 0~\chec$; $y = x^4 \implies y’ = 4x^3, y’’ = 12x^2 \implies x^2y’’ - 4xy’ + 4y = x^2(12x^2) - 4x(4x^3) + 4(x^4) = (12 - 16 + 4)x^4 = 0~\chec$.
<br><br>
...
Use technology to sketch the direction field of $y’ = -y(5-y)$ and thereby determine the behavior of $y$ as $x \ra \infty$.
