...
Find an equation of motion for an object experiencing SHM with an amplitude of $a=4$, a period of $T=\frac{\pi}2$, and, at time $t=0$, moving "down," i.e., in the negative direction, from its "resting" (more properly referred to as its "equilibrium") position.
...
Graph $e^{-\large\frac t{4\pi}}\cos(t), 0 \le t \le 2\pi$
