...
__Revolutions (revs; also called cycles)__: especially used in physics and engineering, __one rev equals one one full circle__, giving the conversion factors __$\displaystyle \frac{360^{\circ}}{1\text{ rev}} = \frac{2\pi\text{ rad}}{1\text{ rev}}$__; __Conversion examples__: 0.25 rev $\times \displaystyle \frac{360^{\circ}}{1\text{ rev}} = 90^{\circ}; \frac{2\pi}3\text{ rad}~\times \frac{1\text{ cycle}}{2\pi\text{ rad}} = \frac13\text{ cycle}$.
