...
__32__) $\displaystyle 1 - \frac12 x = 6$
...
__40__) $\displaystyle \frac4y - 5 = \frac5{2y}$
...
__52__) $\displaystyle \frac{x}{x^2 - 9} + \frac4{x + 3} = \frac3{x^2 - 9}$
...
__56__) $\displaystyle \frac{-4}{x + 4} = \frac{-3}{x + 6}$
...
__60__) $\displaystyle \frac{-4}{2x + 3} + \frac1{x - 1} = \frac1{(2x + 3)(x - 1)}$
...
__64__) $\displaystyle \frac{x + 1}{x^2 + 2x} - \frac{x + 4}{x^2 + x} = \frac{-3}{x^2 + 3x + 2}$
...
__68__) $\displaystyle 18.63x - \frac{21.2}{2.6} = \frac{14}{2.32}x - 20$
...
__74__) Solve for $x$: $\displaystyle \frac{b + c}{x + a} = \frac{b - c}{x - a}, c \ne 0, a$
...
__76__) Find the number $b$ for which $x=2$ is a solution of:$$x + 2b = x - 4 + 2bx$$
...
__88__) Going into the final exam, which will count as two-thirds of the final grade, Mike has test scores of 86, 80, 84, and 90; what score does Mike need on the final in order to earn a B, which requires an average score of 80? What does he need to earn an A, which requires an averageof 90?
...
__90__) A car dealer, at a year-end clearance, reduces the list price of last year’s models by 15%. If a certain four-door model has a discounted price of $8000, what was its list price? How much can be saved bypurchasing last year’s model?
...
__94__) A wool suit, discounted by 30% for a clearance sale, has a price tag of $399. What was the suit’s original price?
...
__28__) $\displaystyle \frac5{x + 4} = 4 + \frac3{x - 2}$
...
__34__) Solve $(3z - 2)^2 = 4$ using "the square-root method."
...
__40__) Solve $2x^2 - 3x - 1 = 0$ by completing the square.
...
In Problems __44__, __54__, & __64__, find the real solutions, if any, of each equation using the quadratic formula: $$ax^2+bx+c=0 \iff x = \frac{-b\pm\sqrt{b^2-4ac}}{2a}$$.
...
__Sln__: $a=4, b=-6, c=9$, so $\displaystyle u = \frac{-(-6)\pm\sqrt{(-6)^2-4(4)(9)}}{2(4)} = \frac{6\pm\sqrt{36-144}}8 = \frac{6\pm\sqrt{-108}}8$; since the discriminant is less than zero, this equation has $\boxed{\text{no real solutions}}$.
...
__64__) $\displaystyle \frac{2x}{x - 3} + \frac1x = 4$
...
__86__) $\displaystyle \frac12 x^2 = \sqrt2 x + 1$
...
__90__) $\displaystyle \frac{3x}{x + 2} + \frac1{x - 1} = \frac{4 - 7x}{x^2 + x - 2}$
...
__92__) How many right triangles have a hypotenuse that measures $4x + 5$ inches and legs that measure $3x + 13$ inches and $x$ inches? What are the dimensions of the triangle(s)?
...
__Chk__: We confirm that $9^2+40^2 = 41^2$: the left-hand-side $= 81 + 1600 = 1681 = 41^2.~\checkmark~$ (Confirming that this is indeed the only right triangle satisfying the requirements can be done by graphing $y=3x^2-19x-72$ to see that the other $x$-intercept is negative, which is left to the reader.)
<br><br>

__96__) An adjustable water sprinkler that sprays water in a circular pattern is placed at the center of a square field whose area is 1250 square feet (see the figure in the text). What is the shortest radius setting that can be used if the field is to be completely enclosed within the circle?
...
__104__) A circular pool measures 10 feet across; one cubic yard of concrete is to be used to create a circular border of uniform width around the pool. If the border is to have a depth of 4 inches, howwide will the border be? (1 cubic yard 27 cubic feet) See illustration (Note: not to scale).
...
__Chk__: $\ell/w = 40/30 = 4/3~\checkmark$, $40^2+30^2 = 1600 + 900 = 2500 = 50^2~\checkmark$.
...
__112__) Show that the product of the roots of a quadratic equationis $\displaystyle \frac ca$.
...
__114__) Find $k$ such that the equation $x^2 - kx + 4 = 0$ has a repeated real solution.
...
__116__) Show that the real solutions of the equation $$ax^2+bx+c=0~~~(\text{Eq. "}ac\text{"})$$are the reciprocals of the real solutions of the equation 
...
### Section 3: Complex Numbers; Quadratic Equations in the Complex Number System
...
__28__) $\displaystyle \frac{2 + 3i}{1 - i}$
...
__78__) Determine the character of the solutions of $4x^2 + 12x + 9 = 0$ without solving the equation.

__Sln__: $b^2-4ac = (12)^2-4(4)(9) = 144 - 144 = 0 \implies \boxed{\text{ one real solution (of multiplicity 2)}}$.
<br><br>

__80__) $4-i$ is a solution of a quadratic equation with realcoefficients. Find the other solution.
...
__84__) Given $z = 3 - 4i$ and $w = 8 + 3i$, write $\overline{z - w}$ in $a+bi$ form.
...
__90__) Use $z = a + bi$ and $w = c + di$ to show that $\overline{z \cdot w} = \overline{z} \cdot \overline{w}$.
...
### Section 4: Radical Equations; Equations Quadratic in Form; Factorable Equations
...
__72__) $\displaystyle \left(\frac{y}{y - 1}\right)^2 = 6\left(\frac{y}{y - 1}\right) + 7$
...
__88__) $3x(x^2 + 2x)^{1/2} - 2(x^2 + 2x)^{3/2} = 0$
...
__96__) If $k = \displaystyle \frac{x+3}{x-4}$ and $k^2 - 3k = 28$, find $x$.
...
__16__) Express the graph shown in blue using interval notation, and as an inequality involving $x$.
...
__22d__) Write the inequality obtained multiplying $1 - 2x \gt 5$ by $-2$.
...
__46__) If $x \gt -2$, then $-4x\;\_\_\_\;8.$
...
__52__) If $\displaystyle -\frac14 x \gt 1$, then $x\;\_\_\_\;-4.$
...
__66__) $3x + 4 \gt \displaystyle \frac13(x - 2)$
...
__94__) If $-3 \lt x \lt 3$, then $a \lt 1 - 2x \lt b$.
...
__98__) If $0 \lt 2x \lt 6$, then $a \lt x^2 \lt b$.

__Sln__: First we multiply by $\frac12$: $\frac12[0 \lt 2x \lt 6] \implies 0 \lt x \lt 3 \implies \boxed{0} \lt x^2 \lt 3^2=\boxed{9}$
<br><br>

__100__) What is the ("natural") domain of the variable in the expression $\sqrt{8+2x}$?
...
__118__) If $0\lt a \lt b$, show that $\sqrt{ab} \lt (a+b)/2$ (i.e., the geometric mean is less than the arithmetic mean).
...
__121__) __Another Reciprocal Property__ Prove that if $0 \lt a \lt b$, then $\displaystyle 0 \lt \frac1b \lt \frac1a$.
...
### Section 6: Equations and Inequalities Involving Absolute Value
...
__20__) $\displaystyle \left|\frac{x}{2}-\frac13\right| = 1$
...
__32__) $\displaystyle \left|\frac{2x+1}{3x+4}\right| = 1$
...
__62__) $\displaystyle \left|\frac{2x - 3}2 + \frac13\right|\gt 1$
...
__70__) Express the statement "$x$ differs from 2 by more than 3" as aninequality involving an absolute value and solve for $x$.
...
__76__) Find $a,b$ such that the following implication is true: if $|x+1| \le 3$, then $\displaystyle a \le \frac1{x+5} \le b$.
...
__82__) If $a \gt 0$, show that $\left\{x| x \lt -\sqrt a \text{ or } x \gt \sqrt a\right\}$ is the solution set of $x^2 \gt a$.
...
__92__) Solve $\left|x + |3x - 2| \right| = 2$.
...
### Section 7: Problem Solving: Interest, Mixture, Uniform Motion, Constant Rate Job Applications

__12__ and __16__: Translate into a mathematical (i.e., symbolic) equation, and define all symbols used.

__12__) __Physics__ Pressure is force per unit area.
...
__16__) __Business__ The total revenue derived from selling $x$ dishwashers is \$250 per dishwasher times the number of dishwasherssold.
...
__36__) __Construction__ A pond is enclosed by a wooden deck that is3 feet wide; the fence surrounding the deck is 100 feet long.
