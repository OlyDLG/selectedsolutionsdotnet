...
__48__) Find all points on the $y$-axis that are 6 units from the point $(4, -3)$.
...
__58__) Given $P_1 = (7, 2); P_2 = (-4, 0); P_3 = (4, 6)$, find the length of each side of the triangle determined by these points and state whether it is isosceles, right, both or neither.
...
__38__) Given $P=(-3,0)$, state the coordinates of the point symmetric to it  wrt each axis and the origin.
...
__46__) <img src="./Graphs/SullivanC2S2P46.png" height=250>
...
__48__) <img src="./Graphs/SullivanC2S2P48.png" height=250>
...
__50__) <img src="./Graphs/SullivanC2S2P50.png" height=250>

__Sln__: The graph appears to have $\boxed{\text{no intercepts}}$; and $\boxed{\text{symmetry wrt the }x\text{-axis only.}}$
<br><br>

__54__) Complete the following graph so that it is symmetric wrt the $y$-axis:
...
__70__) $y = \displaystyle \frac{x^4 + 1}{2x^5}$
...
__74__) (Instead of drawing a quick sketch) generate a graph of  $y=\displaystyle \frac1x$ using a graphing utility.
...
__78__) Find $a$ so that $(a, -5)$ is a point on the graph of $y = x^2 + 6x$.
...
__84__) Find the intercepts and symmetries (if any) of $16y^2 = 120x - 225$.
...
__22__) Graph and give the slope of the line passing through $(2, 0)$ and $(2, 2)$
...
__26__) $P = (1, 3); m = \displaystyle -\frac25$
...
__42__) $L$ is parallel to $y = –x$ and passes through $(1,2)$.
...
__44__) $L$ is perpendicular to $y = –x$ and passes through $(-1,1)$.
...
__54__) $x$-intercept $= -4$; $y$-intercept $= 4$
...
__56__ & __58__) Slope undefined, containing the point $(3, 8)$; and "vertical," containing the point $(4, -5)$.
...
__64__) Parallel to the line $y = 5$, containing the point $(4, 2)$.
...
__68__) Perpendicular to the line $x - 2y = -5$, containing the point $(0, 4)$.
...
__110__) A line with intercepts $(-2,0), (0,-1)$ is pictured: 
...
__114__) $(0, 0), (1, 3), (4, 2), \&~(3,-1)$ are the vertices of what kind of shape?
...
__10__) $(0,1)$ and $(2,3)$ appear to be the endpoints of a diameter of a pictured circle: write the standard form of this circle’s equation.
...
__20__) Give the standard and general form of the equation and graph of the circle defined by: radius $\displaystyle =\frac12$, center $\displaystyle = (0,-\frac12)$.
...
__30__) Find the: __a__) center and radius; __b__) graph; and __c__) intercepts (if any); of $x^2 + y^2 + x + y - \frac12 = 0$. 
...
__38__) Center $(-3, 1)$ and tangent to the $y$-axis.
...
__40__) With endpoints of a diameter at $(4, 3)$ and $(0, 1)$.
...
__54__) Use the Greek method (the slope of the tangent is found from the fact that the tangent is perpendicular to the line joining the point of tangency to the center of the circle) to find an equation of the tangent line to the circle $x^2 + y^2 - 4x + 6y + 4 = 0$at the point $(3,2\sqrt2 - 3)$.
...
__6__) $V$ varies directly with $x^3$; $V = 36\pi$ when $x = 3$.
...
__10__) $T$ varies jointly with the cube root of $x$ and the square of $d$;$T = 18$ when $x = 8$ and $d = 3$.
...
__14__) The cube of $z$ varies directly with the sum of the squares of $x$ and $y$; $z = 2$ when $x = 9$ and $y = 4$.
